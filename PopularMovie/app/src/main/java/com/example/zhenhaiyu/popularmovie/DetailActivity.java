...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            Log.d(LOG_TAG, "savedInstanceState: " + mMovie.mTitle);
            ...
            if (intent != null && intent.hasExtra(getResources().getString(R.string.title_activity_detail))) {
                ...
                Log.d(LOG_TAG, "get Intent: " + mMovie.mTitle);
            }
        }
        ...
        collapsingToolbar.setTitle(mMovie.mOriginalTitle);
//        collapsingToolbar.setExpandedTitleTextAppearance(R.style.DetailHeader_TextStyle);
    ...
    private void loadView() {
        ...
        Log.d(LOG_TAG, mMovie.mReleaseDate);
